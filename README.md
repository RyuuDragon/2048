...
<img width="510" height="444" alt="image" src="https://github.com/user-attachments/assets/5a8012dc-bbc0-409b-a32a-99e57a019a1e" />
...
### Что применял в коде
- **Прямое управление Label-элементами**.
- **Динамическая генерация интерфейса**.
- **Тройные вложенные циклы**.
- **Линейный поиск**.
- **Newtonsoft.Json** — `JsonConvert.SerializeObject()` с `Formatting.Indented`, `JsonConvert.DeserializeObject<List<string[]»()`.
- **Собственный FileManager**.
- **ООП**.
